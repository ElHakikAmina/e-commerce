    <div class="header d-flex flex-wrap  justify-content-between">
        ...
        <a href="http://localhost/electromaroc/index" class="text-decoration-none ChakraPetch "><span class=" text-dark fs-1"><span class="text-primary ">E</span>LECTRO</span><span class=" text-muted ">Maroc</span></a>
        </div>
        <!---->
        <div class="mx-auto">
